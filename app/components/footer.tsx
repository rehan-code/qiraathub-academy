          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a href="https://www.youtube.com/@qiraat" className="text-gray-600 hover:text-red-600 transition-colors" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.facebook.com/QiraatHub/" className="text-gray-600 hover:text-blue-600 transition-colors" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/qiraathub/" className="text-gray-600 hover:text-pink-600 transition-colors" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://x.com/QiraatHub" className="text-gray-600 hover:text-[#1DA1F2] transition-colors" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
